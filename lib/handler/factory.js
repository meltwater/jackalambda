...
import { createBasicWrapper } from '../wrapper'
 ...
 * @param {createWrapper} [options.createWrapper=createBasicWrapper] - A factory function that will return the processor wrapped in additional functionality
...
export function createHandler({
  ...
  createWrapper = createBasicWrapper,
  createProcessor,
  t
}) {
