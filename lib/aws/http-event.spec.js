...
test('should throw reqId is not a string', validateProperty, {
  propertyToBreak: 'reqId',
  badValue: 1234
})

test('should throw reqId is an empty string', validateProperty, {
  propertyToBreak: 'reqId',
  badValue: ''
})
...
test('reqId should be immutable', immutable, 'reqId')
