...
export class EventbridgeClient {
   ...
   * @param {Object} payload - The events to pass to eventbridge.Entries. Entries input structure is identical to the AWS Entry type, except all keys are in lower camelcase, the Detail should be a plain serializable object, and the EventBusName should be omitted.
